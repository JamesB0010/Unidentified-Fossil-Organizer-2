...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        private bool skiddingOutOfControl;

        public UnityEvent StartSkidding;

        public UnityEvent StopSkidding;

        public void SkidOutOfControl()
        {
            if (this.skiddingOutOfControl)
                return;
            StartSkidding?.Invoke();
            skiddingOutOfControl = true;
        }
        ...
        void OnCollisionEnter(Collision collision)
        {
            ...
            if (this.skiddingOutOfControl)
            {
                ...
                this.alive = false;
                this.StopSkidding?.Invoke();
                this.Dead?.Invoke();
                StartCoroutine(nameof(this.LoadBeachAfterDelay));
                Debug.Log("Dead");
            }
        }

        private IEnumerator LoadBeachAfterDelay()
        {
            yield return new WaitForSeconds(3);
            SceneManager.LoadScene("THE BEACH");
        }
