...
namespace MeetAndTalk.Nodes
{
    public class DialogueChoiceNode : BaseNode
    {
        ...
        private ObjectField fmodEventRefField;
        public FmodEventRefObj modEventRef;
        ...
        public DialogueChoiceNode(Vector2 _position, DialogueEditorWindow _editorWindow, DialogueGraphView _graphView)
        {
            ...
            fmodEventRefField = new ObjectField
            {
                objectType = typeof(FmodEventRefObj),
                allowSceneObjects = false
            };
            fmodEventRefField.RegisterValueChangedCallback(value =>
            {
                this.modEventRef = value.newValue as FmodEventRefObj;
            });
            fmodEventRefField.SetValueWithoutNotify(modEventRef);
            mainContainer.Add(fmodEventRefField);
