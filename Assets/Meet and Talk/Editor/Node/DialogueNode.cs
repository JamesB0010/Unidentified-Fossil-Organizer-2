...
namespace MeetAndTalk.Nodes
{
    public class DialogueNode : BaseNode
    {
        ...
        public FmodEventRefObj fmodEventRef;
        ...
        public DialogueNode(Vector2 _position, DialogueEditorWindow _editorWindow, DialogueGraphView _graphView)
        {
            ...
            this.testField = new ObjectField
            {
                objectType = typeof(FmodEventRefObj),
                allowSceneObjects = false
            };
            
            this.testField.RegisterValueChangedCallback(value =>
            {
                this.fmodEventRef = value.newValue as FmodEventRefObj;
            });
            testField.SetValueWithoutNotify(this.fmodEventRef);
