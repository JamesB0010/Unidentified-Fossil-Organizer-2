...
public class Underwater : ScriptableRendererFeature
{
    ...
    class Pass : ScriptableRenderPass
    {
        ...
        {
            UnderwaterVolumeComponent volume = VolumeManager.instance.stack.GetComponent<UnderwaterVolumeComponent>();

            if (volume == null || volume.IsActive() == false || renderingData.cameraData.postProcessEnabled == false)
                return;
