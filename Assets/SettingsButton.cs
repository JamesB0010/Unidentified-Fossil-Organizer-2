...
public class SettingsButton : MonoBehaviour
{
    ...
    public void ClickedButton()
    {
        ...
        this.nameInput.transform.position.LerpTo(new Vector3(-442.99f, oldPos.y, oldPos.z), 0.6f, value => this.nameInput.transform.position = value, null, this.playAndCreditsLeaveAnimCurve);
        ...
        this.CreditsButton.transform.position.LerpTo(new Vector3(-442.99f, oldPos.y, oldPos.z), 0.6f,
            ...
            {
                this.settingsBackgroundPanel.transform.position.LerpTo(new Vector3(Screen.width / 2, Screen.height / 2, 0), 1f, val => this.settingsBackgroundPanel.transform.position = val, null, this.playAndCreditsLeaveAnimCurve);
            }, this.playAndCreditsLeaveAnimCurve);

        this.eventSystem.SetSelectedGameObject(this.masterSlider);
    }
}
